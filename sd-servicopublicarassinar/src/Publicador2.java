    ...
    public static void main(String[] args) {
        ...
        try {           
            ...
            while(conectado) {
                ...
                switch(topico){
                    case 1:
                        retorno = inter3.publish(Topicos.TOPICO_1);
                        break;
                    case 2:
                        retorno = inter3.publish(Topicos.TOPICO_2);
                        break;
                    case 3:
                        retorno = inter3.publish(Topicos.TOPICO_3);
                        break;
                    case 4:
                        retorno = inter3.publish(Topicos.TOPICO_4);
                        break;
                    case 5:
                        retorno = inter3.publish(Topicos.TOPICO_5);
                        break;
                }
                if(retorno){                    
